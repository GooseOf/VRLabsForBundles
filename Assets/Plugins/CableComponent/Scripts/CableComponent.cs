...
public class CableComponent : MonoBehaviour
{
	...
	public void InitLineRenderer()
	{
		...
		/*for (int i = 0; i<cableMaterial.Length; i++)
        {
	...
	void RenderCable()
	{
		...
		{
			if(line != null) { line.SetPosition(pointIdx, points[pointIdx].Position); }             //if else
	...
	{
		Vector3 gravityDisplacement = Time.fixedDeltaTime * Time.fixedDeltaTime * Physics.gravity*(-1);
		if (points != null)                                                                         //if else
		{
